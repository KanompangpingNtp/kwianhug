...
class AdminExecutiveIntentionsController extends Controller
{
    public function ExecutiveIntentionsAdmin()
    {
        ...
        return view('admin.post.executive_intentions.page', compact('basicInfoDetail', 'basicInfoType'));
    }

    public function ExecutiveIntentionsCreate(Request $request)
    {
        $request->validate([
    ...
    public function ExecutiveIntentionsDelete($id)
    {
