...
class AdminMessageFromPMController extends Controller
{
    public function  MessageFromPMAdmin()
    {
        ...
        return view('admin.post.message_from_pm.page', compact('basicInfoDetail', 'basicInfoType'));
    }

    public function MessageFromPMCreate(Request $request)
    {
        $request->validate([
    ...
    public function MessageFromPMDelete($id)
    {
