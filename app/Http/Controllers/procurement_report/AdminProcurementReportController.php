...
class AdminProcurementReportController extends Controller
{
    public function ProcurementReportHome()
    {
    ...
    public function ProcurementReportCreate(Request $request)
    {
        $request->validate([
        ...
        if ($request->hasFile('file_post')) {
            foreach ($request->file('file_post') as $file) {
                ...
                $path = $file->storeAs('pdf/procurement_report', $filename, 'public');
    ...
    public function ProcurementReportUpdate(Request $request, $id)
    {
        $request->validate([
            'date' => 'nullable|date',
            'title_name' => 'nullable|string',
    ...
    public function ProcurementReportDelete($id)
    {
