...
namespace App\Http\Controllers\eservice\engineering_department\construction_certification;
...
class ConstructionController extends Controller
{
    ...
    {
        return view('eservice.users.engineering_department.construction_certification.page');
    }
    ...
    public function TableCertificationUsersPages()
    {
        ...
        return view('eservice.users.engineering_department.construction_certification.account.show-detail', compact('forms'));
    }
    ...
    public function CertificationUserExportPDF($id)
    {
        ...
        $pdf = Pdf::loadView('eservice.users.engineering_department.construction_certification.pdf-form', compact('form'))
