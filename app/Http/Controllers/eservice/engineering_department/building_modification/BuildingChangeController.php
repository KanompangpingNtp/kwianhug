...
namespace App\Http\Controllers\eservice\engineering_department\building_modification;
...
class BuildingChangeController extends Controller
{
    ...
    {
        return view('eservice.users.engineering_department.building_modification.page');
    }
    ...
    public function BuildingChangeUsersPages()
    {
        ...
        return view('eservice.users.engineering_department.building_modification.account.show-detail', compact('forms'));
    }
    ...
    public function BuildingChangeUserExportPDF($id)
    {
        ...
        $pdf = Pdf::loadView('eservice.users.engineering_department.building_modification.pdf-form', compact('form'))
