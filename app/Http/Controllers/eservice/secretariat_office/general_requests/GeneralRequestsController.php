...
namespace App\Http\Controllers\eservice\secretariat_office\general_requests;
...
class GeneralRequestsController extends Controller
{
    ...
    {
        return view('eservice.users.municipal_office.general_requests.page');
    }
    ...
    public function GeneralRequestsShowDetails()
    {
        ...
        return view('eservice.users.municipal_office.general_requests.account.show-detail', compact('forms'));
    }
    ...
    public function GeneralRequestsUserShowFormEdit($id)
    {
        ...
        return view('eservice.users.municipal_office.general_requests.account.edit-data', compact('form'));
    }
