...
namespace App\Http\Controllers\eservice\secretariat_office\disability;
...
class DisabilityController extends Controller
{
    ...
    {
        return view('eservice.users.municipal_office.disability.page');
    }
    ...
    public function TableDisabilityUsersPages()
    {
        ...
        return view('eservice.users.municipal_office.disability.account.show-detail', compact('forms'));
    }
    ...
    public function DisabilityUserShowEdit($id)
    {
        ...
        return view('eservice.users.municipal_office.disability.account.edit-data', compact('form'));
    }
    ...
    public function DisabilityUserExportPDF($id)
    {
        ...
        $pdf = Pdf::loadView('eservice.users.municipal_office.disability.pdf-form', compact('form', 'documentType'))
