...
namespace App\Http\Controllers\eservice\secretariat_office\elderly_allowance;
...
class ElderlyAllowanceController extends Controller
{
    ...
    {
        return view('eservice.users.municipal_office.elderly_allowance.page');
    }
    ...
    public function ElderlyAllowanceShowDetails()
    {
        ...
        return view('eservice.users.municipal_office.elderly_allowance.account.show-detail', compact('forms'));
    }
    ...
    public function ElderlyAllowanceUserShowEdit($id)
    {
        ...
        return view('eservice.users.municipal_office.elderly_allowance.account.edit-data', compact('form'));
    }
    ...
    public function ElderlyAllowanceUserExportPDF($id)
    {
        ...
        $pdf = Pdf::loadView('eservice.users.municipal_office.elderly_allowance.pdf-form', compact('form', 'documentType'))
