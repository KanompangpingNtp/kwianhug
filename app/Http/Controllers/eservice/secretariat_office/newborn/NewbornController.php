...
namespace App\Http\Controllers\eservice\secretariat_office\newborn;
...
class NewbornController extends Controller
{
    ...
    {
        return view('eservice.users.municipal_office.newborn.page');
    }
    ...
    public function NewbornShowDetails()
    {
        ...
        return view('eservice.users.municipal_office.newborn.account.show-detail', compact('forms'));
    }
    ...
    public function NewbornUserShowEdit($id)
    {
        ...
        return view('eservice.users.municipal_office.newborn.account.edit-data', compact('form'));
    }
    ...
    //     $pdf = Pdf::loadView('eservice.users.municipal_office.funeral.pdf-form', compact('form', 'documentType'))
