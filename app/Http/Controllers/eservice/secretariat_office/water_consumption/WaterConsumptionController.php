...
namespace App\Http\Controllers\eservice\secretariat_office\water_consumption;
...
class WaterConsumptionController extends Controller
{
    ...
    {
        return view('eservice.users.municipal_office.water_consumption.page');
    }
    ...
    public function WaterConsumptionShowDetails()
    {
        ...
        return view('eservice.users.municipal_office.water_consumption.account.show-detail', compact('forms'));
    }
    ...
    public function WaterConsumptionUserExportPDF($id)
    {
        ...
        $pdf = Pdf::loadView('eservice.users.municipal_office.water_consumption.pdf-form', compact('form'))->setPaper('A4', 'portrait');
