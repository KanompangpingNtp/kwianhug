...
namespace App\Http\Controllers\eservice\education_department\child_apply;
...
class ChildApplyController extends Controller
{
    ...
    {
        return view('eservice.users.education_department.child_apply.page');
    }
...
// ');
    ...
    public function TableChildApplyUsersPages()
    {
        ...
        return view('eservice.users.education_department.child_apply.account.show-detail', compact('forms'));
    }
