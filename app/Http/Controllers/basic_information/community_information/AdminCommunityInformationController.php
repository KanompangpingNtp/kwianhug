...
class AdminCommunityInformationController extends Controller
{
    public function  CommunityAdmin()
    {
        ...
        return view('admin.basic_information.community_information.page', compact('basicInfoDetail', 'basicInfoType'));
    }
