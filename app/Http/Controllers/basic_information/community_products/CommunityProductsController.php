...
class CommunityProductsController extends Controller
{
    public function  CommunityProductsPage()
    {
        ...
        return view('users.pages.basic_information.community_products.page', compact(
            'listDetail',
            'personnelAgencies',
            'PerfResultsMenu',
            'AuthorityMenu',
    ...
    public function ShowDetails($id)
    {
        ...
        return view('users.pages.basic_information.community_products.show_details', compact(
            'listDetail',
            'personnelAgencies',
            'PerfResultsMenu',
            'AuthorityMenu',
