        ...
        <div class="row mb-3">
            <div class="col-12 col-md-2">
                ...
                <select class="form-select" id="salutation" name="salutation" disabled>
                    ...
                    <option value="นาย" {{ old('salutation_parent', $form->salutation) == 'นาย' ? 'selected' : '' }}>นาย</option>
                    <option value="นาง" {{ old('salutation_parent', $form->salutation) == 'นาง' ? 'selected' : '' }}>นาง</option>
                    <option value="นางสาว" {{ old('salutation_parent', $form->salutation) == 'นางสาว' ? 'selected' : '' }}>นางสาว</option>
                </select>
            </div>
