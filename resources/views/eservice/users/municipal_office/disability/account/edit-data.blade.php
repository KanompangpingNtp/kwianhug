    ...
    <div class="container">
        ...
        <form action="{{ route('DisabilityUserFormUpdate', $form->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="written_at" name="written_at" class="form-control"
                            value="{{ old('date', $form->written_at) }}" required disabled>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="date" id="written_date" name="written_date" class="form-control"
                            value="{{ old('written_date', $form->written_date) }}" disabled>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="salutation" name="salutation" class="form-control"
                            value="{{ old('salutation', $form->salutation) }}" disabled>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="first_name" name="first_name" class="form-control"
                            value="{{ old('first_name', $form->first_name) }}" disabled>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="last_name" name="last_name" class="form-control"
                            value="{{ old('last_name', $form->last_name) }}" disabled>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="date" id="birth_day" name="birth_day" class="form-control"
                            value="{{ old('birth_day', $form->birth_day) }}" disabled>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="number" id="age" name="age" class="form-control"
                            value="{{ old('age', $form->age) }}" disabled>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="nationality" name="nationality" class="form-control"
                            value="{{ old('nationality', $form->nationality) }}" disabled>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="house_number" name="house_number" class="form-control"
                            value="{{ old('house_number', $form->house_number) }}" disabled>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="village" name="village" class="form-control"
                            value="{{ old('village', $form->village) }}" disabled>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="alley" name="alley" class="form-control"
                            value="{{ old('alley', $form->alley) }}" disabled>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="road" name="road" class="form-control"
                            value="{{ old('road', $form->road) }}" disabled>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="subdistrict" name="subdistrict" class="form-control"
                            value="{{ old('subdistrict', $form->subdistrict) }}" disabled>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="district" name="district" class="form-control"
                            value="{{ old('district', $form->district) }}" disabled>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="province" name="province" class="form-control"
                            value="{{ old('province', $form->province) }}" disabled>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="postal_code" name="postal_code" class="form-control"
                            value="{{ old('postal_code', $form->postal_code) }}" disabled>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="phone_number" name="phone_number" class="form-control"
                            value="{{ old('phone_number', $form->phone_number) }}" disabled>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="citizen_id" name="citizen_id" class="form-control"
                            value="{{ old('citizen_id', $form->citizen_id) }}" disabled>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col">
                        <div class="form-check">
                            <input type="radio" class="form-check-input" id="type_of_disability_option3"
                                ...
                                {{ old('type_of_disability', $form->type_of_disability) == 'option3' ? 'checked' : '' }} disabled>
                    ...
                    <div class="col">
                        <div class="form-check">
                            <input type="radio" class="form-check-input" id="type_of_disability_option4"
                                ...
                                {{ old('type_of_disability', $form->type_of_disability) == 'option4' ? 'checked' : '' }} disabled>
                            <label class="form-check-label"
                    ...
                    <div class="col">
                        <div class="form-check">
                            <input type="radio" class="form-check-input" id="type_of_disability_option5"
                                ...
                                {{ old('type_of_disability', $form->type_of_disability) == 'option5' ? 'checked' : '' }} disabled>
                            <label class="form-check-label"
                    ...
                    <div class="col">
                        <div class="form-check">
                            <input type="radio" class="form-check-input" id="type_of_disability_option6"
                                ...
                                {{ old('type_of_disability', $form->type_of_disability) == 'option6' ? 'checked' : '' }} disabled>
                    ...
                    <div class="col">
                        <div class="form-check">
                            <input type="radio" class="form-check-input" id="type_of_disability_option7"
                                ...
                                {{ old('type_of_disability', $form->type_of_disability) == 'option7' ? 'checked' : '' }} disabled>
                            <label class="form-check-label"
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9">
                    <input type="text" id="monthly_income" name="monthly_income" class="form-control"
                        value="{{ old('monthly_income', $form->monthly_income) }}" disabled>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9">
                    <input type="text" id="occupation" name="occupation" class="form-control"
                        value="{{ old('occupation', $form->occupation) }}" disabled>
                </div>
            </div>
                ...
                <div class="col-12 col-md-6">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="welfare_type[]" id="welfare_type_aid"
                            value="option1"
                            {{ in_array('option1', old('welfare_type', $form->disabilityOptions->first()->welfare_type ?? [])) ? 'checked' : '' }} disabled>
                ...
                <div class="col-12 col-md-6">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="welfare_type[]"
                            ...
                            {{ in_array('option2', old('welfare_type', $form->disabilityOptions->first()->welfare_type ?? [])) ? 'checked' : '' }} disabled>
                        <label class="form-check-label"
                ...
                <div class="col-12 col-md-6">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="welfare_type[]"
                            ...
                            {{ in_array('option3', old('welfare_type', $form->disabilityOptions->first()->welfare_type ?? [])) ? 'checked' : '' }} disabled>
                ...
                <div class="col-12 col-md-6">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="welfare_type[]"
                            ...
                            {{ in_array('option4', old('welfare_type', $form->disabilityOptions->first()->welfare_type ?? [])) ? 'checked' : '' }} disabled>
            ...
            <div id="welfare_other_types_div" class="row mb-3"
                style="display: {{ in_array('option4', old('welfare_type', $form->disabilityOptions->first()->welfare_type ?? [])) ? 'block' : 'none' }};" disabled>
                ...
                <div class="col-sm-9">
                    <input type="text" id="welfare_other_types" name="welfare_other_types" class="form-control"
                        ...
                        placeholder="กรอกข้อมูลเพิ่มเติม" disabled>
                </div>
            </div>
            ...
            <div class="my-4">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="request_for_money_type" id="money_type_option2"
                        value="option2"
                        {{ old('request_for_money_type', $form->disabilityOptions->first()->request_for_money_type ?? '') == 'option2' ? 'checked' : '' }} disabled>
                    <label class="form-check-label"
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="request_for_money_type" id="money_type_option3"
                        value="option3"
                        {{ old('request_for_money_type', $form->disabilityOptions->first()->request_for_money_type ?? '') == 'option3' ? 'checked' : '' }} disabled>
                    <label class="form-check-label"
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="request_for_money_type" id="money_type_option4"
                        value="option4"
                        {{ old('request_for_money_type', $form->disabilityOptions->first()->request_for_money_type ?? '') == 'option4' ? 'checked' : '' }} disabled>
                    <label class="form-check-label"
                ...
                <div class="col-12 col-md-6">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="document_type[]"
                            ...
                            {{ in_array('option1', $documentTypeArray) ? 'checked' : '' }} disabled>
                ...
                <div class="col-12 col-md-6">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="document_type[]"
                            ...
                            {{ in_array('option2', $documentTypeArray) ? 'checked' : '' }} disabled>
                ...
                <div class="col-12 col-md-6">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="document_type[]"
                            ...
                            {{ in_array('option3', $documentTypeArray) ? 'checked' : '' }} disabled>
                ...
                <div class="col-12 col-md-6">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="document_type[]"
                            ...
                            {{ in_array('option4', $documentTypeArray) ? 'checked' : '' }} disabled>
                        <label class="form-check-label"
            ...
            <div class="col-12 col-md-6">
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="bank_option" id="bank_option" value="1"
                        ...
                        {{ old('bank_option', $form->disabilityBankAccounts->first()->bank_option ?? '') == '1' ? 'checked' : '' }} disabled>
            ...
            <div class="form-group" id="bank_name_group" style="display: none;">
                ...
                <input type="text" id="bank_name" name="bank_name" class="form-control"
                    value="{{ old('bank_name', $form->disabilityBankAccounts->first()->bank_name ?? '') }}" disabled>
            </div>
            ...
            <div class="form-group" id="account_number_group" style="display: none;">
                ...
                <input type="text" id="account_number" name="account_number" class="form-control"
                    value="{{ old('account_number', $form->disabilityBankAccounts->first()->account_number ?? '') }}" disabled>
            </div>
            ...
            <div class="form-group" id="account_name_group" style="display: none;">
                ...
                <input type="text" id="account_name" name="account_name" class="form-control"
                    value="{{ old('account_name', $form->disabilityBankAccounts->first()->account_name ?? '') }}" disabled>
            </div>
