...
@section('content')
<div class="container">
    <h2 class="text-center mb-4">ฟอร์มส่งคำร้องทั่วไป (กองการศึกษา)</h2>

    <form action="{{route('EducationGeneralFormCreate')}}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="mb-3">
            <label for="request_details" class="form-label">เรื่องร้องเรียนต่อเทศบาลตำบลเกวียนหัก กรณี<span class="text-danger">*</span></label>
            <textarea class="form-control" id="request_details" name="request_details" rows="3" required></textarea>
        </div>

        <div class="mb-3">
            <label for="proceedings" class="form-label">ข้าพเจ้าขอความอนุเคราะห์ให้เทศบาลตำบลเกวียนหัก ดำเนินการ<span class="text-danger">*</span></label>
