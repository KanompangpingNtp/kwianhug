...
<body>
    ...
    <div class="regis_number" style="margin-top:2rem;">เขียนที่ ศูนย์พัฒนาเด็กเล็กเทศบาลตำบลเกวียนหัก
    </div>
    ...
    <div class="box_text" style="text-align: left; margin-top: 5px; ">
        <div style="margin-left: 2rem;"> ๓. ข้าพเจ้ายินดีปฏิบัติตามระเบียบ
            ข้อกำหนดของเทศบาลตำบลเกวียนหัก และยินดี
    ...
    <div class="title_doc" style="text-align:center;">
        ...
        <div>
            เทศบาลตำบลเกวียนหัก อำเภอขลุง จังหวัดจันทบุรี
        </div>
    </div>
    <div class="box_text" style="text-align: left; margin-top: 1rem; ">
        ...
        <div> {{$form->surrenderTheChild->first()->child_surrender_salutation1}} <span class="dotted-line" style="width: 65%; text-align: left; margin-top:20px;">{{ $form->surrenderTheChild->first()->childs_name }}
            ...
            <div>พัฒนาเด็กเล็กเทศบาลตำบลเกวียนหัก และพร้อมที่จะปฏิบัติตามระเบียบการของศูนย์</div>
            <div>พัฒนาเด็กเล็กเทศบาลตำบลเกวียนหัก ดังนี้</div>
        </div>
        <div style="margin-left: 2rem;"> 1. จะปฏิบัติตามระเบียบ
            ข้อบังคับของศูนย์พัฒนาเด็กเล็กเทศบาลตำบลเกวียนหัก อย่างเคร่งครัด
        </div>
        <div style="margin-left: 2rem;"> 2. จะร่วมมือกับศูนย์พัฒนาเด็กเล็กเทศบาลตำบลเกวียนหัก
