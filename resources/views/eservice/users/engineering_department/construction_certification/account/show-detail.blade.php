    ...
    <table class="table table-bordered table-striped" id="data_table">
        ...
        <tbody class="text-center">
            ...
            <tr>
                ...
                <td>
                    <a href="#" class="btn btn-warning btn-sm text-white"><i class="bi bi-pencil-square"></i></a>
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <a href="{{ route('CertificationUserExportPDF', $form->id) }}" class="btn btn-danger btn-sm" target="_blank">
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('CertificationUserReply', $form->id) }}" method="POST">
                        @csrf
                        <div class="mb-3">
