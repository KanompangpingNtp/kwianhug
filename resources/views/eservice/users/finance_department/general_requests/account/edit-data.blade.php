    ...
    <form action="{{ route('GeneralRequestsUserUpdateForm', $form->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row g-3 mb-3">
            <div class="col-md-6">
                ...
                <input type="date" class="form-control" id="date" name="date" value="{{ old('date', $form->date) }}" disabled>
            </div>
            <div class="col-md-6">
                <label for="subject" class="form-label">เรื่อง</label>
                <input type="text" class="form-control" id="subject" name="subject" value="{{ old('subject', $form->subject) }}" disabled>
            </div>
        </div>

        <div class="mb-3">
            <label for="included" class="form-label">สิ่งที่ส่งมาด้วย<span class="text-danger">*</span></label>
            <textarea class="form-control" id="included" name="included" rows="2" disabled>{{ old('included', $form->included) }}</textarea>
        </div>
        ...
        <div class="row g-3 mb-3">
            <div class="col-md-3">
                ...
                <input type="text" class="form-control" id="salutation" name="salutation" value="{{ old('salutation', $form->salutation) }}" disabled>
            </div>
            <div class="col-md-6">
                <label for="name" class="form-label">ชื่อ - นามสกุล</label>
                <input type="text" class="form-control" id="name" name="name" value="{{ old('name', $form->name) }}" disabled>
            </div>
            <div class="col-md-3">
                <label for="age" class="form-label">อายุ</label>
                <input type="number" class="form-control" id="age" name="age" value="{{ old('age', $form->age) }}" disabled>
            </div>
        </div>
        ...
        <div class="row g-3 mb-3">
            <div class="col-md-4">
                ...
                <input type="text" class="form-control" id="house_number" name="house_number" value="{{ old('house_number', $form->house_number) }}" disabled>
            </div>
            <div class="col-md-4">
        ...
        <div class="row g-3 mb-3">
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control" id="phone" name="phone" value="{{ old('phone', $form->phone) }}" disabled>
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" id="request_details" name="request_details" rows="3" disabled>{{ old('request_details', $form->request_details) }}</textarea>
        </div>
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" id="proceedings" name="proceedings" rows="3" disabled>{{ old('proceedings', $form->proceedings) }}</textarea>
        </div>
        ...
        {{-- <div class="mb-3">
            ...
            <input type="file" class="form-control" id="attachments" name="attachments[]" multiple disabled>
