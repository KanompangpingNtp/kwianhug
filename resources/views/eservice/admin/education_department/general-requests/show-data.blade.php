...
<div class="container">
    <h2 class="text-center">คำร้องทั่วไป (กองการศึกษา)<br>
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <a href="{{ route('EducationGeneralAdminExportPDF', $form->id) }}" class="btn btn-danger btn-sm" target="_blank">
                ...
                <div class="modal-footer d-flex justify-content-between">
                    ...
                    <form action="{{ route('EducationGeneralUpdateStatus', $form->id) }}" method="POST">
                    @csrf
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('EducationGeneralAdminReply', $form->id) }}" method="POST">
                        @csrf
                        <div class="mb-3">
