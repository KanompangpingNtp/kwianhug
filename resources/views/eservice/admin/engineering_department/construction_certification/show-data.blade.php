...
<div class="container">
    <h3 class="text-center">คำขอรับรองสิ่งปลูกสร้างอาคาร <br>
    ...
    <table class="table table-bordered table-striped" id="data_table">
        ...
        <tbody class="text-center">
            ...
            <tr>
                ...
                <td>
                    {{-- <a href="{{ route('CertificationShowFormEdit', $form->id) }}" class="btn btn-warning btn-sm text-white" style="font-size:21px; padding-top:5px; padding-bottom:5px;"><i class="bi bi-pencil-square"></i></a> --}}
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <a href="{{ route('CertificationAdminExportPDF', $form->id) }}" class="btn btn-danger btn-sm" target="_blank">
                ...
                <div class="modal-footer d-flex justify-content-between">
                    ...
                    <form action="{{ route('CertificationUpdateStatus', $form->id) }}" method="POST">
                        @csrf
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('CertificationAdminReply', $form->id) }}" method="POST">
                        @csrf
                        <div class="mb-3">
