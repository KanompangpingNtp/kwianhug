...
<div class="bg py-5">
    <div class="container py-5 custom-gradient-shadow">
        <div class=" d-flex flex-column justify-content-center p-5 ">
            <div class="fs-1 fw-bold mb-4 text-center">องค์กรแห่งการเรียนรู้ (KM)</div>
            ...
            <table class="table">
                ...
                <tr>
                    <td><a href="{{route('LearningOrganizationShowDetails',$detail->id)}}">{{ $detail->list_details_name }}</a></td>
                </tr>
                @endforeach
            </table>
