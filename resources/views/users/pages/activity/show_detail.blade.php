    ...
    <div class="bg py-5">
        <div class="container py-5 custom-gradient-shadow">
            <div class=" d-flex flex-column justify-content-center p-5">
                <div class="fs-1 fw-bold mb-4 text-center">กิจกรรม <br><span
                        ...
                        @foreach ($activity->photos->whereIn('post_photo_status', ['1', '2']) as $index => $photo)
                            <div class="col-lg-1 col-md-2 col-sm-3 col-4 mb-3 text-center">
                                <img src="{{ asset('storage/' . $photo->post_photo_file) }}"
                                    class="img-thumbnail rounded shadow-sm" alt="รูปแนบ"
                ...
                @if ($activity->pdfs->count() > 0)
                    ...
                    @foreach ($activity->pdfs as $pdf)
                        <div class="mb-3">
                            <iframe src="{{ asset('storage/' . $pdf->post_pdf_file) }}" width="100%"
                                height="700px"></iframe>
                        </div>
                    @endforeach
                @endif
