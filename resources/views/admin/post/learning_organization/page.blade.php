...
@section('title', 'องค์กรแห่งการเรียนรู้ (KM)')
@section('content')

<link rel="stylesheet" href="https://cdn.datatables.net/1.13.7/css/jquery.dataTables.min.css">

<h2 class="text-center">องค์กรแห่งการเรียนรู้ (KM)</h2><br>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('LearningOrganizationNameCreate') }}" method="POST">
                @csrf
                <div class="modal-body">
                    <div class="mb-3">
                        <input type="hidden" name="basic_info_type" value="{{ $basicInfoType->firstWhere('type_name', 'KM')->id }}">
...
<table class="table table-bordered" id="data_table">
    ...
    <tbody>
        ...
        <tr>
            <td>{{ $index + 1 }}</td>
            <td>
                <a href="{{ route('LearningOrganizationShowDertails', $detail->id) }}">
            ...
            <td class="text-center">
                ...
                <div class="d-inline-block">
                    <form action="{{ route('LearningOrganizationNameDelete', $detail->id) }}" method="POST" onsubmit="return confirm('คุณต้องการลบข้อมูลนี้?');">
                        @csrf
                        @method('DELETE')
...
<div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('LearningOrganizationNameUpdate', $detail->id) }}" method="POST">
                @csrf
                <div class="modal-body">
