...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" style="margin-top: 5%;">
        <div class="modal-content">
            ...
            <form action="{{ route('LearningOrganizationDetailsCreate',$listDetail->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center">
                ...
                <form action="{{ route('LearningOrganizationDetailsDelete', $details->id) }}" method="POST" style="display:inline;">
                    @csrf
                    @method('DELETE')
