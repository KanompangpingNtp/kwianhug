...
@section('title', 'ผลประกาศจัดซื้อจัดจ้าง')
@section('content')
<div class="row">
    <div class="col-md-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="text-center">ผลประกาศจัดซื้อจัดจ้าง</h3>
                        ...
                        <div class="modal-content">
                            ...
                            <form action="{{ route('ProcurementResultsCreate') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <input type="hidden" name="post_type_id" value="{{ $postTypes->firstWhere('type_name', 'ผลประกาศจัดซื้อจัดจ้าง')->id }}">
