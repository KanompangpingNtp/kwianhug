...
<div class="row">
    <div class="col-md-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="text-center">แนะนำสถานที่ท่องเที่ยว</h3>
                        ...
                        <div class="modal-content">
                            ...
                            <form action="{{route('TouristAttractionCreate')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        <input type="hidden" name="post_type_id" value="{{ $postTypes->firstWhere('type_name', 'แนะนำสถานที่ท่องเที่ยว')->id }}">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{ route('TouristAttractionDelete', $postDetail->id) }}" method="POST" style="display:inline;">
                                @csrf
                                @method('DELETE')
                ...
                <div class="modal fade" id="editModal-{{ $postDetail->id }}" tabindex="-1" aria-labelledby="editModalLabel-{{ $postDetail->id }}" aria-hidden="true">
                    <div class="modal-dialog modal-lg" style="margin-top: 5%;">
                        <div class="modal-content">
                            ...
                            <form action="{{ route('TouristAttractionUpdate', $postDetail->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="modal-body">
