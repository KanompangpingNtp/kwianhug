...
@if(empty($listDetail->details) && $listDetail->images->isEmpty())
    <form action="{{ route('ImportantPlacesDertailsCreate', $listDetail->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
