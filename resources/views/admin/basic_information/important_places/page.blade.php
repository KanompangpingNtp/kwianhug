...
@section('title', 'สถานที่สำคัญ')
@section('content')

<link rel="stylesheet" href="https://cdn.datatables.net/1.13.7/css/jquery.dataTables.min.css">

<h2 class="text-center">สถานที่สำคัญ</h2><br>

<button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal">
    สร้างชื่อ สถานที่สำคัญ
</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel"> สร้างชื่อ สถานที่สำคัญ</h1>
            ...
            <form action="{{ route('CommunityProductsNameCreate') }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <input type="hidden" name="basic_info_type" value="{{ $basicInfoType->firstWhere('type_name', 'สถานที่สำคัญ')->id }}">
                        <label for="list_details_name" class="form-label">ชื่อสถานที่สำคัญ</label>
